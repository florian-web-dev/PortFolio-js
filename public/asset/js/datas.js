    ...
    "skills":
    {
        ...
        "analyse": [
            ...
            },
            {
                ...
                "className": "classDiagram reveal-1",
    ...
    "realisation": [
        {
            ...
            "type": "Frontend",
            "imgUrl": "",
            "subtitle": "Apprendre en s’exerçant",
            "context": "Autodidacte",
            "linkGit": "",
            "bataBase": "",
            ...
            "templateProces": "",
            "content": "Lorsque j’ai commencé le développement, j’ai commencé pas de la théorie, il m’a fallu donc mettre en pratique mes nouvel connaissance. J’ai donc commencé par crée des One page, puis à essayer de reproduire des pages d’accueils de site ou parfois de tutoriel, la contrainte était de refaire avec un screen et une liste des fonctionnalités apparente, en voici donc quelqu’une",
            "language": [
                {
                    "id": 1,
                    "name": "html5"
        ...
        },
        {
            ...
            "imgUrl": "public/img/realisation/suivie_seance/maquetteDashbordAcceuil.png",
            ...
            "analyse": [
                ...
                {
                    "id": 5,
                    "figcaption": "Maquette Dashbord Acceuil.",
                    "nameFile": "maquetteDashbordAcceuil.png",
                    "imgMiniUrl": "../public/img/realisation/suivie_seance/maquetteDashbordAcceuil.png",
                    "imgUrl": "../public/img/realisation/suivie_seance/maquetteDashbordAcceuil.png",
                    "caption": "<b>Maquette Dashbord Acceuil </b> <br/> Projet suivi séance."
                }
                ,
                {
                    "id": 6,
                    "figcaption": "Teste de vérification de la cohérence des données.",
                    "nameFile": "screenTeste.png",
                    "imgMiniUrl": "../public/img/realisation/suivie_seance/sreenTestMini.jpg",
                    "imgUrl": "../public/img/realisation/suivie_seance/screenTeste.png",
                    "caption": "<b>Teste de vérification de la cohérence des données </b> <br/> Projet suivi séance."
                }
            ]
        },
        {
            ...
            "slug": "food-easy-home",
            "type": "Backend/Frontend",
            "imgUrl": "public/img/realisation/food_easy_home/header.PNG",
            ...
            "analyse": [
                ...
                {
                    "id": 4,
                    "figcaption": "Maquette page produits.",
                    "nameFile": "produitMaquette.png",
                    "imgMiniUrl": "../public/img/realisation/food_easy_home/produitMaquette.png",
                    "imgUrl": "../public/img/realisation/food_easy_home/produitMaquette.png",
                    "caption": "<b>Maquette page produits. </b> <br/> Projet Food Easy Home."
                }
            ]
        },
        {
            "id": 4,
            "title": "Mini Projets VusJs",
            "slug": "mini-projets-vusjs",
            "type": "Frontend",
            "imgUrl": "",
            "subtitle": "Plusieurs projet Vuejs",
            ...
            "templateProces": "",
            "content": "<b>Objectif</b> : Réaliser une 'bombe' avec VusJs, le but est découvert le framework crée des composants, comprendre leurs cycles de vie. <b>Objectif</b> : Dans la continuité j’ai aussi réalisé un jeu de chifoumi, j’y est incorporé un modal contenant un formulaire afin de comprendre comme l’ajout de composant venant de la documentions fonctionne. <b>Objectif</b> : Réaliser un CRUD complet, avec un API reste Java j’ai accédé au donné les l’API en utilisant à Axios, le Store et des clef tokens de connexion",
            "language": [
                {
                    "id": 1,
                    "name": "html5"
        ...
        {
            "id": 5,
            "title": "Mini Projets Android",
            "slug": "projet-adroid",
            "type": "Android",
            "imgUrl": "",
            "subtitle": "Plusieurs projet Android",
            "context": "Autodidacte",
            "linkGit": "",
            "bataBase": "no-database",
            "mimeFileDataBase": "svg",
            "sizeFileDataBase": "5rem",
            "templateProces": "",
            "content": "<b>Objectif</b> : Réaliser un quiz sur android. <b>Objectif</b> : .",
            "language": [
                {
                    "id": 1,
                    "name": "html5"
        ...
        {
            "id": 6,
            "title": "Application multi-platforme",
            "slug": "application-multi-platforme",
            "imgUrl": "",
            "subtitle": "ionic",
            "context": "Concepteur Développeur Application ",
            "linkGit": "",
            ...
            "sizeFileDataBase": "5rem",
            "templateProces": "thymeleaf",
            "content": "Cette application réalisée via Vujs/ionic, Capacitor et d’autre package. Le but de cette application et d’apprendre et de réaliser des tests. J’ai donc regardé des tutoriels et surtout la documentation. J’ai commencé par faire une Todolist, puis je souhaite j’ai fait un chifoumi, puis des dés en 3D ainsi qu’une carte de visite avec un QR code. Avec comme contraire technique de reste sur l’API 21 afin d’être compatible de la version Oreo d’Android a la plus ressente, version 8 de gradle",
            "language": [
                {
                    "id": 1,
                    "name": "html5"
